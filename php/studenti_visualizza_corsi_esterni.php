<?php
  ...
  function disegna_tabella($risultato) {
    while ($riga = mysqli_fetch_assoc($risultato)) {
      ...
      echo "<div class=\"col\"> <a href=\"studenti_visualizza_corsi_esterni.php?codice=" . $riga["Codice"] . "&matricola_studente=" . $_REQUEST["matricola_studente"] . "\" class=\"align-self-center w-75\"><input type=\"button\" class=\"btn btn-outline-light my-3 py-3 w-100\" name=\"\" value=\"Iscriviti\"></a> </div>";
      echo "</div>";
    }
  }
  ...
  function iscriviti($matricola, $codice) {
    ...
    $query = "INSERT INTO studenti_corsi_esterni VALUES ($matricola, $codice)";
  ...
  require "../studenti_visualizza_corsi_esterni.html";
