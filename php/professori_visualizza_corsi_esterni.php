<?php
  ...
  function perTitolo($value) {
    ...
    $query = "SELECT * FROM corsi_esterni WHERE Titolo LIKE \"%$value%\"";
  ...
  function perCodice($value) {
    ...
    $query = "SELECT * FROM corsi_esterni WHERE Codice=\"$value\"";
  ...
  function perOre($valueDa, $valueA) {
    ...
    $query = "SELECT * FROM corsi_esterni WHERE Totale_Ore BETWEEN $valueDa AND $valueA";
  ...
  require "../professori_visualizza_corsi_esterni.html";
